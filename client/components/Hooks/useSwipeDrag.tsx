...
export default function useSwipeDrag(ref: RefObject<HTMLDivElement>, maxDrag: number, actionThreshold: number, action: () => void, toggleScroll: ((scrollOn: boolean) => void) | undefined, allowToScroll?: RefObject<HTMLElement>) {
  const dragXRef= useRef<number | null>(null);
  const setDragX = (dragX: number | null) => {
    if (ref.current) {
