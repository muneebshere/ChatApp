  ...
  function parseString(str, options) {
    return replace(str, function (rawText) {
      ...
      if (iconId && src) {
        ...
        ret = `<img class="${options.className}" draggable="false" alt="${rawText}" style="background-image:url(&quot;${src}&quot;);" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNgYAAAAAMAASsJTYQAAAAASUVORK5CYII="`;
        attrib = options.attributes(rawText, iconId);
        for (attrname in attrib) {
          if (
            attrib.hasOwnProperty(attrname) &&
